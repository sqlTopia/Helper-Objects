...
RETURNS TABLE
AS
RETURN  WITH cteTableTriggers(schema_id, schema_name, table_id, table_name, trigger_id, trigger_name, trigger_definition, is_disabled, is_ms_shipped)
        AS (
